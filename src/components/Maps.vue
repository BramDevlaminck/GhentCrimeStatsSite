...
<template>
  <div>
      <InteractiveMap :all-features="allFeaturesWithoutUnknown" :begin-date="beginDate" :end-date="endDate"
                      :crime-types="crimeTypes" :quarter-geometry-data="quarterGeometryData" :bike-parking-per-quarter="bikeParkingPerQuarter" :quarter-geometry-data-without-unknown="quarterGeometryDataWithoutUnknown" :quarter-geometry-small="quarterGeometrySmall"/>
